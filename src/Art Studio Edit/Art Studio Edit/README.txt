...
4. "Browse", you may choose a (.ajart / .ajgart file -> Decode),
   ...
   is the size of the Art Studio canvas. If decoding,
   make sure the UUID corresponds with the account
   that created the artwork originally. If you are making
   pixel art however, the format is first 51p x 31p when
   you edit the image, but before the final import that
...
5. "Encode" or "Decode". When decoding, you are always
   ...
   When encoding, you always choose an image to
   translate into a .ajart file in the same directory.
   Note that when you encode a .ajart file with any 
   specific UUID, it will only load on that account in AJ.

   
    ╔╝╦══════════════════════════════════════════════════════════════════╦╚╗
 ╚╬╝                 DISCUSS  -  SHARE  -  REUPLOAD                   ╚╬╝
  ╚════════════════════════════════════════════════════════════════════╝
